...
SPD : $(LIBARYS_PATH)/spd$(SPD_VER)
	...
	@( cd $(RAPTOR_DATA)/spd$(SPD_VER)/jacks_scenes ; change_resolution.pl --format nff --x_res 800 --y_res 600 --file jacks_2.nff )
	@( cd $(RAPTOR_DATA)/spd$(SPD_VER)/jacks_scenes ; change_resolution.pl --format nff --x_res 800 --y_res 600 --file jacks_3.nff )
	@( cd $(RAPTOR_DATA)/spd$(SPD_VER)/jacks_scenes ; change_resolution.pl --format nff --x_res 800 --y_res 600 --file jacks_4.nff )
	@( cd $(RAPTOR_DATA)/spd$(SPD_VER)/jacks_scenes ; change_resolution.pl --format nff --x_res 800 --y_res 600 --file jacks_5.nff )
...
all :	SDL2-$(SDL_VER) SDL2_ttf-$(SDLTTF_VER) SDL2_image-$(SDLIMAGE_VER) freefont-$(FREEFONT_VER) freetype-$(FREETYPE_VER) tbb$(TBB_VER) fftw-$(FFTW_VER) ffmpeg spd$(SPD_VER) SPD boost_$(BOOST_VER)
